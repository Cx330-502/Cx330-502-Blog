...
![新建虚拟环境](/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic20.png)

进入该环境后，然后先安装 jupyter notebook 的软件包。
...
首先新建一个文件夹，作为 jupyter notebook 的工作目录，并进入该工作目录。
...
![生成jupyter配置文件](/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic21.png)

我们会看到，系统输出了配置文件所在的路径，先记住它，等会要用。

接下来我们设置密码，输入 `jupyter server password` 后回车，输入两遍密码即可。

![更改密码](/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic22.png)
...
![哈希密码](/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic23.png)
...
![启动 jupyter 服务](/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic24.png)

在浏览器中输入 `ip地址:8888` 即可进入jupyter notebook的登陆页面。

![登录jupyter](/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic25.png)

输入密码后即可看到我们的工作目录并开始写代码啦。

![jupyter notebook主页](/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic26.png)

当然，此时我们的服务器命令还还一直在运行着jupyter服务，感兴趣的同学可以研究下[Tmux](https://blog.csdn.net/qq_50511203/article/details/129329451)让它一直在后台运行~
