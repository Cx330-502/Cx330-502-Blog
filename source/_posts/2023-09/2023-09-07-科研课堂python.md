...
在Linux中，可以使用 `namespace` 和 `cgroups` 机制隔离一个或一组进程。至于 `namespace` 和 `cgroups` 机制到底是什么，在这里就不详述了，如果有兴趣的可以在[这里]([掌握这些 Docker 原理知识，出去吹牛逼再也不担心了 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/137082437))查看容器实现环境隔离的具体原理。
...
+ [**Windows安装docker**]([Windows Docker 安装 | 菜鸟教程 (runoob.com)](https://www.runoob.com/docker/windows-docker-install.html))
+ [**MacOS安装docker**]([MacOS Docker 安装 | 菜鸟教程 (runoob.com)](https://www.runoob.com/docker/macos-docker-install.html))
+ **Linux安装docker**
  + [**Ubuntu Docker 安装**]([Ubuntu Docker 安装 | 菜鸟教程 (runoob.com)](https://www.runoob.com/docker/ubuntu-docker-install.html))
  + [**Debian Docker 安装**]([Debian Docker 安装 | 菜鸟教程 (runoob.com)](https://www.runoob.com/docker/debian-docker-install.html))
  + [**CentOS Docker 安装**]([CentOS Docker 安装 | 菜鸟教程 (runoob.com)](https://www.runoob.com/docker/centos-docker-install.html))
...
现在，大家应该已经以管理员身份打开了 Windows 终端 ，也就是在影视作品里常见的黑框框。
