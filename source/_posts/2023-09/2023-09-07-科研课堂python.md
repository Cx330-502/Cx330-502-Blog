...
![Miniconda下载页面](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic1.png)
...
![虚拟机](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic2.png)
...
![虚拟机和容器](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic3.png)
...
![容器进行时](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic4.png)

![容器进行时](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic5.png)
...
![Docker](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic6.png)
...
![Docker使用](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic7.png)
...
![Docker运行于虚拟机上](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic8.png)
...
![Docker安装界面](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic9.png)

点击 OK 后即可开始安装~

安装完成后，再次重启电脑.会出现 docker 的条款页面，点击接受就能启动 docker 啦！

![Docker条款](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic10.png)
...
![Docker界面](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic11.png)
...
![Docker镜像源配置](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic12.png)

#### Docker 架构

中间的很多过程我也不会，先放张图再这。直接进入下一节吧orz。

![Docker架构](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic13.png)
...
![Docker列出镜像](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic14.png)
...
![Docker容器状态](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic15.png)
...
<font color="red"><b>该部分很无聊，非常无聊</b></font><br>

<font color="red"><b>不建议无命令行基础的同志看</b></font><br>

<font color="red"><b>即使有基础，如果使用的是Windows或MacOS也不建议看</b></font><br>

<font color="red"><b>建议直接看下面的<i>"Docker图形化界面"</i>部分</b></font><br>
...
![Docker图形化界面](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic16.png)

直接点击运行，然后在容器界面：

![Docker图形化界面](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic17.png)
...
![Docker构建镜像](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic18.png)

此时，我们就可以在 docker 的GUI界面上看到新的镜像了：

![Docker镜像构建成功](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic19.png)
...
![新建虚拟环境](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic20.png)
...
![生成jupyter配置文件](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic21.png)

我们会看到，系统输出了配置文件所在的路径，先记住它，等会要用。

接下来我们设置密码，输入 `jupyter server password` 后回车，输入两遍密码即可。

![更改密码](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic22.png)

这里又生成了一个配置文件，我们通过 vim 命令访问一下。

>可能有对 vim 不熟悉的同学，这是一个很nb的编辑器。有很多指令，可以在[Vim 编辑器 - 基础入门_vim入门_Amentos的博客-CSDN博客](https://blog.csdn.net/Amentos/article/details/129202797)学习一下~

```shell
vim /home/ubuntu/.jupyter/jupyter_server_config.json
```

![哈希密码](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic23.png)
...
c.NotebookApp.password = u'' # 把引号中的内容替换为刚刚复制的哈希密码
c.NotebookApp.notebook_dir = u'/home/ubuntu/jupyter_notebook' # 第一步创建的工作目录
...
![启动 jupyter 服务](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic24.png)

在浏览器中输入 `ip地址:8888` 即可进入jupyter notebook的登陆页面。

![登录jupyter](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic25.png)

输入密码后即可看到我们的工作目录并开始写代码啦。

![jupyter notebook主页](/Cx330-502-Blog/files_/pics/post_pics/2023-09/2023-09-07-科研课堂python/pic26.png)

当然，此时我们的服务器命令还一直在运行着jupyter服务，感兴趣的同学可以研究下[Tmux](https://blog.csdn.net/qq_50511203/article/details/129329451)让它一直在后台运行~
